...
\Cref{tab:configB-results} reports the Configuration B comparison. Mean returns rank Linear-Q (0.666) above DQN (0.640) above random (0.559), while survival ranks DQN (68.1\%) above Linear-Q (66.6\%) above random (65.0\%). The two metrics still disagree, but the gap narrowed once DQN was properly tuned.
